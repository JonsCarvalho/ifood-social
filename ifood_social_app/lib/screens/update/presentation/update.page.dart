...
import 'package:ifood_social_app/screens/create/presentation/components/dropdown_category_button.widget.dart';
import 'package:ifood_social_app/screens/update/presentation/components/bottom_nav_bar.dart';
import 'package:ifood_social_app/screens/update/presentation/components/forms.widget.dart';
import 'package:ifood_social_app/screens/update/presentation/components/product_image.widget.dart';
...
class _UpdatePageState extends State<UpdatePage> {
  ...
  Future<void> onDelete() async {
    await _controller.onDelete(id: widget.product.id!.toString());
